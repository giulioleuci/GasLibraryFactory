...
export class LoggerServiceMock {
  constructor() {
    ...
    this.logJobResume = jest.fn().mockReturnThis();
    this.logJobEnd = jest.fn().mockReturnThis();
    this.logJobSuspended = jest.fn().mockReturnThis();
    this.logBatchStart = jest.fn().mockReturnThis();
    this.logItemStart = jest.fn().mockReturnThis();
    this.logStep = jest.fn().mockReturnThis();
