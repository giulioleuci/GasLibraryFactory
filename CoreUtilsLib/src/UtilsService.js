...
export class MyUtilsService {
  static get MILLIS_PER_DAY() { return DateUtils.MILLIS_PER_DAY; }
  static get MILLIS_PER_HOUR() { return DateUtils.MILLIS_PER_HOUR; }
  static get MILLIS_PER_MINUTE() { return DateUtils.MILLIS_PER_MINUTE; }
  static get MILLIS_PER_SECOND() { return DateUtils.MILLIS_PER_SECOND; }
  ...
  constructor(sleepFn = null) {
    ...
    managers.forEach(manager => {
      ...
      const protoMethods = Object.getOwnPropertyNames(Object.getPrototypeOf(manager))
        .filter(name => name !== 'constructor' && typeof manager[name] === 'function');
      
      // Get own methods (for nested facades)
      const ownMethods = Object.getOwnPropertyNames(manager)
